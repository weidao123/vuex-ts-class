...
import {ActionTree, GetterTree, ModuleTree, MutationTree, Plugin, Store} from "vuex";
...
export interface ServiceInter {

    readonly vuexStoreConfig: VuexStoreConfig

    registerModule(vuexModule: any): void
